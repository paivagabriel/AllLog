...
public class CreditCardView extends FrameLayout {
    ...
    public void setCardHolderName(String cardHolderName) {
        ...
        if (cardHolderName.length() > CreditCardUtils.MAX_LENGTH_CARD_HOLDER_NAME) {
            cardHolderName = cardHolderName.substring(0, CreditCardUtils.MAX_LENGTH_CARD_HOLDER_NAME);
        }
